    ...
    <section id="experience" className="py-20 px-4 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-[#007dff] to-[#009fff] bg-clip-text text-transparent mb-4">Professional Experience</h2>
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow border-l-4" style={{borderLeftColor: '#007dff'}}>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="text-gray-500 bg-gradient-to-r from-[#007dff]/10 to-[#009fff]/10 px-4 py-2 rounded-full text-sm font-medium mt-2 md:mt-0 self-start border border-[#007dff]/20">
                  {exp.period}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {exp.technologies.map((tech, techIndex) => (
                  <span key={techIndex} className="bg-gradient-to-r from-[#007dff] to-[#009fff] text-white px-3 py-1 rounded-full text-sm font-medium">
                    {tech}
                  </span>
                ))}
              </div>
